...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _node_1139 ("node_1139", Range(0, 1)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = mul(UNITY_MATRIX_MVP, float4(v.vertex.xyz + v.normal*_node_1139,1) );
                return o;
            }
