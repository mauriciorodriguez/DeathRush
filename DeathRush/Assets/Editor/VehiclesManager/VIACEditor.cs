...
[CustomEditor(typeof(VehicleIAController)), CanEditMultipleObjects]
public class VIACEditor : Editor
{
    private VehicleIAController _target;
    ...
    void OnEnable()
    {
        _target = (VehicleIAController)target;
    ...
    public override void OnInspectorGUI()
    {
     //   DrawDefaultInspector();
        ...
        if (GUI.changed) Undo.RegisterUndo(_target, "VIAC Change");
    ...
    private void ShowValues()
    {
        ...
        if (generalConfig)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("_nextCheckpoint"), true);
        ...
        if (engineSettings)
        {
            ...
            _target.firstUpGearValor = EditorGUILayout.FloatField("First Up Gear", _target.firstUpGearValor);
            _target.maximunGearUpValor = EditorGUILayout.FloatField("Maximum Gear", _target.maximunGearUpValor);
            _target.minimunGearValor = EditorGUILayout.FloatField("Minimum Gear", _target.minimunGearValor);
        }
