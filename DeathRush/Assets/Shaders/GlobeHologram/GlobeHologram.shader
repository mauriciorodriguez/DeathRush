...
////// Emissive:
                ...
                float node_9568 = 1.0;
                float3 emissive = (((_GlobeTexture_var.rgb*_Color.rgb)*_Brightness)+(lerp((node_9284_if_leA*node_9568)+(node_9284_if_leB*0.0),node_9568,node_9284_if_leA*node_9284_if_leB)*_EdgeColor.rgb));
