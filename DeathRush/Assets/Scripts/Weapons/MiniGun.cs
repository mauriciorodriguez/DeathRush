...
public class MiniGun : Weapon
{
  ...
  //  public Transform shootPoint;
    ...
    public override void Shoot()
    {
        ...
        bala.GetComponent<Ammo>().SetObjectParent(myCollider.GetComponentInParent<VehicleData>());

        if(bala.GetComponent<Collider>() != null && myCollider != null)
            Physics.IgnoreCollision(bala.GetComponent<Collider>(), myCollider); //TODO 
